$(function() {
	...
	function check_phone() {
		...
		if(isNaN($("#form_phone").val())){
			$("#phone_error_message").html("Your Phone number must be numeric");
			$("#phone_error_message").show();
			error_phone = true;
		}
		else if(phone_length < 10) {
			$("#phone_error_message").html("Your phone number must be atleast 10 characters");
			$("#phone_error_message").show();
			error_phone = true;
		} else {
			$("#phone_error_message").hide();
